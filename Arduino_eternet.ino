...
IPAddress ip(192,168,1,76); //Asingamos la IP al Arduino
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
            ...
            client.println("</head>");
            client.println("<body>");
            client.println("<h1 align='center'>Casa Domotica Controlada por Arduino</h1><h4 align='center'>Creado por Humberto Higinio</h4><h2 align='center'>Control de Comedor</h2>");
